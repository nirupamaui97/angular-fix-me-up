/** 
 * TODO -completed: 10. Angular (NX) Architecture
 * TODO- completed: 11. Asynchronous Programming (RxJS)
*/
...
export class AccountSummaryComponent implements OnInit {
  ...
  filterAccounts(accounts: Account[]) {
    this.accounts$  = of(accounts.filter(acc => acc.currency === this.accountsFilter || this.accountsFilter === ''));
  }
}
